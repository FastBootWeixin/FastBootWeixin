 ...
 * @since 4.1
 */
public class WxRequestMappingInfoHandlerMethodMappingNamingStrategy
		implements HandlerMethodMappingNamingStrategy<WxRequestMappingInfo> {
	...
	@Override
	public String getName(HandlerMethod handlerMethod, WxRequestMappingInfo mapping) {
