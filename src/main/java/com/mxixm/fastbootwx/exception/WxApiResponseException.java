package com.mxixm.fastbootwx.exception;
...
public class WxApiResponseException extends WxApiException {
    ...
    public WxApiResponseException(ResponseEntity responseEntity) {
        ...
        this(responseEntity.getBody() instanceof byte[] ? new String((byte[]) responseEntity.getBody()) : String.valueOf(responseEntity.getBody()) , responseEntity);
    }
