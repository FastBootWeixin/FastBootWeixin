 ...
 * @since 0.1.2
 */
public class WxUserUserVoiceMessageProcesser extends AbstractWxUserMediaMessageProcesser<WxUserMessage.Voice, WxMessageBody.Voice> {

    public WxUserUserVoiceMessageProcesser(WxMediaManager wxMediaManager) {
