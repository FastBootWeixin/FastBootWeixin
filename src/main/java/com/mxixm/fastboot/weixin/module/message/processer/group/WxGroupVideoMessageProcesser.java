 ...
 * @since 0.1.2
 */
public class WxGroupVideoMessageProcesser extends AbstractWxGroupMediaMessageProcesser<WxGroupMessage.Video, WxMessageBody.Video> {

    public WxGroupVideoMessageProcesser(WxMediaManager wxMediaManager) {
