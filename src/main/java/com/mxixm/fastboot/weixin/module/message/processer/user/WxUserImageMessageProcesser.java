 ...
 * @since 0.1.2
 */
public class WxUserImageMessageProcesser extends AbstractWxUserMediaMessageProcesser<WxUserMessage.Image, WxMessageBody.Image> {

    public WxUserImageMessageProcesser(WxMediaManager wxMediaManager) {
